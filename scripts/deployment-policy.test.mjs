...
test("resolves assets relative to the preview base", () => {
  assert.deepEqual(
    assetUrls(
      '<base href="/paste-perfect-test/"><script src="main-ABC.js"></script><link href="styles-ABC.css">',
    ).map(String),
    [
      "https://paste-perfect.github.io/paste-perfect-test/main-ABC.js",
      "https://paste-perfect.github.io/paste-perfect-test/styles-ABC.css",
    ],
  );
});
test("rejects an incorrect base, missing script or external asset", () => {
  ...
  assert.throws(() =>
    assetUrls(
      '<base href="/paste-perfect-test/"><script src="https://example.com/main.js">',
    ),
  );
});
